RootIB: RB-20260511160643-76899465

TASK: Generate complete, functional Alexa skill code for this GeneratedSkills entry before deployment.

INPUT:
- Skill name: The Further Survival Guide
- Invocation: the further survival guide
- Category: guide
- Description: Your essential survival-ready guide to the wasteland. Get expert tips, strategies, and advice to help you navigate the wasteland with confidence.
- Lambda handler path: /home/runner/work/barbrickdesign.github.io/barbrickdesign.github.io/GeneratedSkills/The Further Survival Guide/lambda/index.js
- Interaction model path: /home/runner/work/barbrickdesign.github.io/barbrickdesign.github.io/GeneratedSkills/The Further Survival Guide/skill-package/interactionModels/custom/en-US.json
...
// The Further Survival Guide — category: guide, theme: survival
...
const LaunchRequestHandler = {
  ...
  handle(handlerInput) {
    const speakOutput = "The Further Survival Guide is your expert survival-ready guide for the wasteland. Ask for tips, guidance, or say give me advice for your first recommendation.";
...
const HelpIntentHandler = {
  ...
  handle(handlerInput) {
    const speakOutput = "The Further Survival Guide provides survival-ready guidance and expert advice for navigating the wasteland. Say give me advice or give me a tip to get started.";
    return handlerInput.responseBuilder
      .speak(speakOutput)
      .reprompt("Say give me advice or ask for tips about the wasteland.")
      .getResponse();
...
const UnhandledIntentHandler = {
  ...
  handle(handlerInput) {
    ...
    const speakOutput = `I heard ${intentName}, but The Further Survival Guide works best with its main commands right now. The Further Survival Guide provides survival-ready guidance and expert advice for navigating the wasteland. Say give me advice or give me a tip to get started.`;
    return handlerInput.responseBuilder
      .speak(speakOutput)
      .reprompt("Say give me advice or ask for tips about the wasteland.")
      .getResponse();
