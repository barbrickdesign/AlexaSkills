RootIB: RB-20260511160643-7701AFC8

TASK: Generate complete, functional Alexa skill code for this GeneratedSkills entry before deployment.

INPUT:
- Skill name: Device Telemetry Briefing
- Invocation: device telemetry briefing
- Category: briefing
...
- Lambda handler path: /home/runner/work/barbrickdesign.github.io/barbrickdesign.github.io/GeneratedSkills/Device Telemetry Briefing/lambda/index.js
- Interaction model path: /home/runner/work/barbrickdesign.github.io/barbrickdesign.github.io/GeneratedSkills/Device Telemetry Briefing/skill-package/interactionModels/custom/en-US.json
...
// Device Telemetry Briefing — category: briefing, theme: general
...
const LaunchRequestHandler = {
  ...
  handle(handlerInput) {
    const speakOutput = "Device Telemetry Briefing is transmitting. Today's versatile briefing from your world is ready. Say start briefing or status report to receive your update.";
...
const HelpIntentHandler = {
  ...
  handle(handlerInput) {
    const speakOutput = "Device Telemetry Briefing delivers versatile status briefings and updates from your world. Say start briefing for the latest report.";
    return handlerInput.responseBuilder
      .speak(speakOutput)
      .reprompt("Say start briefing or status report.")
      .getResponse();
...
const UnhandledIntentHandler = {
  ...
  handle(handlerInput) {
    ...
    const speakOutput = `I heard ${intentName}, but Device Telemetry Briefing works best with its main commands right now. Device Telemetry Briefing delivers versatile status briefings and updates from your world. Say start briefing for the latest report.`;
    return handlerInput.responseBuilder
      .speak(speakOutput)
      .reprompt("Say start briefing or status report.")
      .getResponse();
