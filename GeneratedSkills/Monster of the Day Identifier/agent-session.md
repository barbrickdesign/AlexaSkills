RootIB: RB-20260511160643-35314D6E

TASK: Generate complete, functional Alexa skill code for this GeneratedSkills entry before deployment.

INPUT:
- Skill name: Monster of the Day Identifier
- Invocation: monster of the day identifier
- Category: identifier
- Description: Identify any general entity, creature, or specimen from your world. Describe what you've encountered and get an instant versatile classification.
- Lambda handler path: /home/runner/work/barbrickdesign.github.io/barbrickdesign.github.io/GeneratedSkills/Monster of the Day Identifier/lambda/index.js
- Interaction model path: /home/runner/work/barbrickdesign.github.io/barbrickdesign.github.io/GeneratedSkills/Monster of the Day Identifier/skill-package/interactionModels/custom/en-US.json
...
// Monster of the Day Identifier — category: identifier, theme: general
...
const LaunchRequestHandler = {
  ...
  handle(handlerInput) {
    const speakOutput = "Monster of the Day Identifier is online. I can identify any general creature, entity, or type based on your description. Describe what you've encountered, or say identify something to begin.";
...
const HelpIntentHandler = {
  ...
  handle(handlerInput) {
    const speakOutput = "Monster of the Day Identifier identifies general entities based on descriptions. Say identify or describe what you've found, and I'll classify it.";
    return handlerInput.responseBuilder
      .speak(speakOutput)
      .reprompt("Tell me what you want to identify, or say identify something.")
      .getResponse();
...
const UnhandledIntentHandler = {
  ...
  handle(handlerInput) {
    ...
    const speakOutput = `I heard ${intentName}, but Monster of the Day Identifier works best with its main commands right now. Monster of the Day Identifier identifies general entities based on descriptions. Say identify or describe what you've found, and I'll classify it.`;
    return handlerInput.responseBuilder
      .speak(speakOutput)
      .reprompt("Tell me what you want to identify, or say identify something.")
      .getResponse();
