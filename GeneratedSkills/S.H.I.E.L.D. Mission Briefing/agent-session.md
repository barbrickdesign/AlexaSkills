RootIB: RB-20260511160643-E6A6F24E

TASK: Generate complete, functional Alexa skill code for this GeneratedSkills entry before deployment.

INPUT:
- Skill name: S.H.I.E.L.D. Mission Briefing
- Invocation: shield mission briefing
- Category: briefing
...
- Lambda handler path: /home/runner/work/barbrickdesign.github.io/barbrickdesign.github.io/GeneratedSkills/S.H.I.E.L.D. Mission Briefing/lambda/index.js
- Interaction model path: /home/runner/work/barbrickdesign.github.io/barbrickdesign.github.io/GeneratedSkills/S.H.I.E.L.D. Mission Briefing/skill-package/interactionModels/custom/en-US.json
...
// S.H.I.E.L.D. Mission Briefing — category: briefing, theme: general
...
const LaunchRequestHandler = {
  ...
  handle(handlerInput) {
    const speakOutput = "S.H.I.E.L.D. Mission Briefing is transmitting. Today's versatile briefing from your world is ready. Say start briefing or status report to receive your update.";
...
const HelpIntentHandler = {
  ...
  handle(handlerInput) {
    const speakOutput = "S.H.I.E.L.D. Mission Briefing delivers versatile status briefings and updates from your world. Say start briefing for the latest report.";
    return handlerInput.responseBuilder
      .speak(speakOutput)
      .reprompt("Say start briefing or status report.")
      .getResponse();
...
const UnhandledIntentHandler = {
  ...
  handle(handlerInput) {
    ...
    const speakOutput = `I heard ${intentName}, but S.H.I.E.L.D. Mission Briefing works best with its main commands right now. S.H.I.E.L.D. Mission Briefing delivers versatile status briefings and updates from your world. Say start briefing for the latest report.`;
    return handlerInput.responseBuilder
      .speak(speakOutput)
      .reprompt("Say start briefing or status report.")
      .getResponse();
