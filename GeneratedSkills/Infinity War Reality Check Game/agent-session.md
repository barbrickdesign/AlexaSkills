RootIB: RB-20260511160643-B562C884

TASK: Generate complete, functional Alexa skill code for this GeneratedSkills entry before deployment.

INPUT:
- Skill name: Infinity War Reality Check Game
- Invocation: infinity war reality check game
- Category: game
- Description: Embark on a heroic interactive adventure in Marvel universe. Make choices, face challenges, and shape the outcome of your story.
- Lambda handler path: /home/runner/work/barbrickdesign.github.io/barbrickdesign.github.io/GeneratedSkills/Infinity War Reality Check Game/lambda/index.js
- Interaction model path: /home/runner/work/barbrickdesign.github.io/barbrickdesign.github.io/GeneratedSkills/Infinity War Reality Check Game/skill-package/interactionModels/custom/en-US.json
