RootIB: RB-20260511160643-2704817E

TASK: Generate complete, functional Alexa skill code for this GeneratedSkills entry before deployment.

INPUT:
- Skill name: Space Exploration Updates
- Invocation: space exploration updates
- Category: utility
- Description: Space Exploration Updates is a cosmic Alexa skill designed to assist you with everyday tasks related to the cosmos.
- Lambda handler path: /home/runner/work/barbrickdesign.github.io/barbrickdesign.github.io/GeneratedSkills/Space Exploration Updates/lambda/index.js
- Interaction model path: /home/runner/work/barbrickdesign.github.io/barbrickdesign.github.io/GeneratedSkills/Space Exploration Updates/skill-package/interactionModels/custom/en-US.json
