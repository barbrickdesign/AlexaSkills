RootIB: RB-20260511160643-40144703

TASK: Generate complete, functional Alexa skill code for this GeneratedSkills entry before deployment.

INPUT:
- Skill name: Symbiote Species Identifier
- Invocation: symbiote species identifier
- Category: identifier
...
- Lambda handler path: /home/runner/work/barbrickdesign.github.io/barbrickdesign.github.io/GeneratedSkills/Symbiote Species Identifier/lambda/index.js
- Interaction model path: /home/runner/work/barbrickdesign.github.io/barbrickdesign.github.io/GeneratedSkills/Symbiote Species Identifier/skill-package/interactionModels/custom/en-US.json
...
// Symbiote Species Identifier — category: identifier, theme: marvel
...
const LaunchRequestHandler = {
  ...
  handle(handlerInput) {
    const speakOutput = "Symbiote Species Identifier is online. I can identify any marvel creature, entity, or type based on your description. Describe what you've encountered, or say identify something to begin.";
...
const HelpIntentHandler = {
  ...
  handle(handlerInput) {
    const speakOutput = "Symbiote Species Identifier identifies marvel entities based on descriptions. Say identify or describe what you've found, and I'll classify it.";
    return handlerInput.responseBuilder
      .speak(speakOutput)
      .reprompt("Tell me what you want to identify, or say identify something.")
      .getResponse();
...
const UnhandledIntentHandler = {
  ...
  handle(handlerInput) {
    ...
    const speakOutput = `I heard ${intentName}, but Symbiote Species Identifier works best with its main commands right now. Symbiote Species Identifier identifies marvel entities based on descriptions. Say identify or describe what you've found, and I'll classify it.`;
    return handlerInput.responseBuilder
      .speak(speakOutput)
      .reprompt("Tell me what you want to identify, or say identify something.")
      .getResponse();
