...
- Lambda handler path: /home/runner/work/barbrickdesign.github.io/barbrickdesign.github.io/GeneratedSkills/Road Trip Game Pack/lambda/index.js
- Interaction model path: /home/runner/work/barbrickdesign.github.io/barbrickdesign.github.io/GeneratedSkills/Road Trip Game Pack/skill-package/interactionModels/custom/en-US.json
...
// Road Trip Game Pack — category: game, theme: general
...
const LaunchRequestHandler = {
  ...
  handle(handlerInput) {
    const speakOutput = "Welcome to Road Trip Game Pack! Enter the versatile world of your world and take on the challenge. Say start game to begin, or help for instructions.";
...
const HelpIntentHandler = {
  ...
  handle(handlerInput) {
    const speakOutput = "Road Trip Game Pack is an interactive versatile experience set in your world. Say start game to begin, and follow the prompts to navigate the adventure.";
    return handlerInput.responseBuilder
      .speak(speakOutput)
      .reprompt("Say start game to begin, or help for instructions.")
      .getResponse();
...
const UnhandledIntentHandler = {
  ...
  handle(handlerInput) {
    ...
    const speakOutput = `I heard ${intentName}, but Road Trip Game Pack works best with its main commands right now. Road Trip Game Pack is an interactive versatile experience set in your world. Say start game to begin, and follow the prompts to navigate the adventure.`;
    return handlerInput.responseBuilder
      .speak(speakOutput)
      .reprompt("Say start game to begin, or help for instructions.")
      .getResponse();
