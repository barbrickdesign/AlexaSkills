...
- Lambda handler path: /home/runner/work/barbrickdesign.github.io/barbrickdesign.github.io/GeneratedSkills/Realm Lore Quiz/lambda/index.js
- Interaction model path: /home/runner/work/barbrickdesign.github.io/barbrickdesign.github.io/GeneratedSkills/Realm Lore Quiz/skill-package/interactionModels/custom/en-US.json
...
// Realm Lore Quiz — category: trivia, theme: general
...
const LaunchRequestHandler = {
  ...
  handle(handlerInput) {
    const speakOutput = "Welcome to Realm Lore Quiz! Test your knowledge of your world across versatile trivia challenges. Say start trivia to begin, or help for instructions.";
...
const HelpIntentHandler = {
  ...
  handle(handlerInput) {
    const speakOutput = "Realm Lore Quiz tests your knowledge of your world. Say start trivia to get versatile questions and track your score.";
    return handlerInput.responseBuilder
      .speak(speakOutput)
      .reprompt("Say start trivia to begin, or help for instructions.")
      .getResponse();
...
const CancelAndStopIntentHandler = {
  ...
  handle(handlerInput) {
    const speakOutput = "Thanks for playing Realm Lore Quiz. Keep exploring your world!";
    return handlerInput.responseBuilder
      .speak(speakOutput)
      .getResponse();
  }
...
const UnhandledIntentHandler = {
  ...
  handle(handlerInput) {
    ...
    const speakOutput = `I heard ${intentName}, but Realm Lore Quiz works best with its main commands right now. Realm Lore Quiz tests your knowledge of your world. Say start trivia to get versatile questions and track your score.`;
    return handlerInput.responseBuilder
      .speak(speakOutput)
      .reprompt("Say start trivia to begin, or help for instructions.")
      .getResponse();
