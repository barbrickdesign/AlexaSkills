RootIB: RB-20260511160643-B0BB1079

TASK: Generate complete, functional Alexa skill code for this GeneratedSkills entry before deployment.

INPUT:
- Skill name: Flare Virus Survival Guide
- Invocation: flare virus survival guide
- Category: guide
...
- Lambda handler path: /home/runner/work/barbrickdesign.github.io/barbrickdesign.github.io/GeneratedSkills/Flare Virus Survival Guide/lambda/index.js
- Interaction model path: /home/runner/work/barbrickdesign.github.io/barbrickdesign.github.io/GeneratedSkills/Flare Virus Survival Guide/skill-package/interactionModels/custom/en-US.json
...
// Flare Virus Survival Guide — category: guide, theme: survival
...
const LaunchRequestHandler = {
  ...
  handle(handlerInput) {
    const speakOutput = "Flare Virus Survival Guide is your expert survival-ready guide for the wasteland. Ask for tips, guidance, or say give me advice for your first recommendation.";
...
const HelpIntentHandler = {
  ...
  handle(handlerInput) {
    const speakOutput = "Flare Virus Survival Guide provides survival-ready guidance and expert advice for navigating the wasteland. Say give me advice or give me a tip to get started.";
    return handlerInput.responseBuilder
      .speak(speakOutput)
      .reprompt("Say give me advice or ask for tips about the wasteland.")
      .getResponse();
...
const UnhandledIntentHandler = {
  ...
  handle(handlerInput) {
    ...
    const speakOutput = `I heard ${intentName}, but Flare Virus Survival Guide works best with its main commands right now. Flare Virus Survival Guide provides survival-ready guidance and expert advice for navigating the wasteland. Say give me advice or give me a tip to get started.`;
    return handlerInput.responseBuilder
      .speak(speakOutput)
      .reprompt("Say give me advice or ask for tips about the wasteland.")
      .getResponse();
