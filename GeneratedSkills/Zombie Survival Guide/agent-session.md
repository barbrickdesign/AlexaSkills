...
- Lambda handler path: /home/runner/work/barbrickdesign.github.io/barbrickdesign.github.io/GeneratedSkills/Zombie Survival Guide/lambda/index.js
- Interaction model path: /home/runner/work/barbrickdesign.github.io/barbrickdesign.github.io/GeneratedSkills/Zombie Survival Guide/skill-package/interactionModels/custom/en-US.json
...
// Zombie Survival Guide — category: guide, theme: survival
...
const LaunchRequestHandler = {
  ...
  handle(handlerInput) {
    const speakOutput = "Zombie Survival Guide is your expert survival-ready guide for the wasteland. Ask for tips, guidance, or say give me advice for your first recommendation.";
...
const HelpIntentHandler = {
  ...
  handle(handlerInput) {
    const speakOutput = "Zombie Survival Guide provides survival-ready guidance and expert advice for navigating the wasteland. Say give me advice or give me a tip to get started.";
    return handlerInput.responseBuilder
      .speak(speakOutput)
      .reprompt("Say give me advice or ask for tips about the wasteland.")
      .getResponse();
...
const UnhandledIntentHandler = {
  ...
  handle(handlerInput) {
    ...
    const speakOutput = `I heard ${intentName}, but Zombie Survival Guide works best with its main commands right now. Zombie Survival Guide provides survival-ready guidance and expert advice for navigating the wasteland. Say give me advice or give me a tip to get started.`;
    return handlerInput.responseBuilder
      .speak(speakOutput)
      .reprompt("Say give me advice or ask for tips about the wasteland.")
      .getResponse();
