RootIB: RB-20260511160643-BE2EA91C

TASK: Generate complete, functional Alexa skill code for this GeneratedSkills entry before deployment.

INPUT:
- Skill name: Ghostface Quote Machine
- Invocation: ghostface quote machine
- Category: character
- Description: Interact with the voices and wisdom of the horror realm. Get terrifying quotes, character lines, and memorable dialogue delivered straight to your Alexa device.
- Lambda handler path: /home/runner/work/barbrickdesign.github.io/barbrickdesign.github.io/GeneratedSkills/Ghostface Quote Machine/lambda/index.js
- Interaction model path: /home/runner/work/barbrickdesign.github.io/barbrickdesign.github.io/GeneratedSkills/Ghostface Quote Machine/skill-package/interactionModels/custom/en-US.json
...
// Ghostface Quote Machine — category: character, theme: horror
...
const LaunchRequestHandler = {
  ...
  handle(handlerInput) {
    const speakOutput = "Ghostface Quote Machine is ready. You can ask me to speak in character, share a line, or deliver wisdom from the horror realm. Say speak to hear something terrifying, or help for options.";
...
const HelpIntentHandler = {
  ...
  handle(handlerInput) {
    const speakOutput = "Ghostface Quote Machine channels characters and voices from the horror realm. Say speak or give me a line for terrifying dialogue.";
    return handlerInput.responseBuilder
      .speak(speakOutput)
      .reprompt("Say speak or ask me something from the horror realm.")
      .getResponse();
...
const UnhandledIntentHandler = {
  ...
  handle(handlerInput) {
    ...
    const speakOutput = `I heard ${intentName}, but Ghostface Quote Machine works best with its main commands right now. Ghostface Quote Machine channels characters and voices from the horror realm. Say speak or give me a line for terrifying dialogue.`;
    return handlerInput.responseBuilder
      .speak(speakOutput)
      .reprompt("Say speak or ask me something from the horror realm.")
      .getResponse();
