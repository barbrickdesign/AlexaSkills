...
- Lambda handler path: /home/runner/work/barbrickdesign.github.io/barbrickdesign.github.io/GeneratedSkills/MI6 Mission Briefing/lambda/index.js
- Interaction model path: /home/runner/work/barbrickdesign.github.io/barbrickdesign.github.io/GeneratedSkills/MI6 Mission Briefing/skill-package/interactionModels/custom/en-US.json
...
// MI6 Mission Briefing — category: briefing, theme: espionage
...
const LaunchRequestHandler = {
  ...
  handle(handlerInput) {
    const speakOutput = "MI6 Mission Briefing is transmitting. Today's top-secret briefing from intelligence world is ready. Say start briefing or status report to receive your update.";
...
const HelpIntentHandler = {
  ...
  handle(handlerInput) {
    const speakOutput = "MI6 Mission Briefing delivers top-secret status briefings and updates from intelligence world. Say start briefing for the latest report.";
    return handlerInput.responseBuilder
      .speak(speakOutput)
      .reprompt("Say start briefing or status report.")
      .getResponse();
...
const UnhandledIntentHandler = {
  ...
  handle(handlerInput) {
    ...
    const speakOutput = `I heard ${intentName}, but MI6 Mission Briefing works best with its main commands right now. MI6 Mission Briefing delivers top-secret status briefings and updates from intelligence world. Say start briefing for the latest report.`;
    return handlerInput.responseBuilder
      .speak(speakOutput)
      .reprompt("Say start briefing or status report.")
      .getResponse();
