...
- Lambda handler path: /home/runner/work/barbrickdesign.github.io/barbrickdesign.github.io/GeneratedSkills/Appointment Companion/lambda/index.js
- Interaction model path: /home/runner/work/barbrickdesign.github.io/barbrickdesign.github.io/GeneratedSkills/Appointment Companion/skill-package/interactionModels/custom/en-US.json
...
// Appointment Companion — category: guide, theme: general
...
const LaunchRequestHandler = {
  ...
  handle(handlerInput) {
    const speakOutput = "Appointment Companion is your expert versatile guide for your world. Ask for tips, guidance, or say give me advice for your first recommendation.";
...
const HelpIntentHandler = {
  ...
  handle(handlerInput) {
    const speakOutput = "Appointment Companion provides versatile guidance and expert advice for navigating your world. Say give me advice or give me a tip to get started.";
    return handlerInput.responseBuilder
      .speak(speakOutput)
      .reprompt("Say give me advice or ask for tips about your world.")
      .getResponse();
...
const UnhandledIntentHandler = {
  ...
  handle(handlerInput) {
    ...
    const speakOutput = `I heard ${intentName}, but Appointment Companion works best with its main commands right now. Appointment Companion provides versatile guidance and expert advice for navigating your world. Say give me advice or give me a tip to get started.`;
    return handlerInput.responseBuilder
      .speak(speakOutput)
      .reprompt("Say give me advice or ask for tips about your world.")
      .getResponse();
