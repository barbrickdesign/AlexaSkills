RootIB: RB-20260511160643-26755FDA

TASK: Generate complete, functional Alexa skill code for this GeneratedSkills entry before deployment.

INPUT:
- Skill name: Demonic Entity Identifier
- Invocation: demonic entity identifier
- Category: identifier
...
- Lambda handler path: /home/runner/work/barbrickdesign.github.io/barbrickdesign.github.io/GeneratedSkills/Demonic Entity Identifier/lambda/index.js
- Interaction model path: /home/runner/work/barbrickdesign.github.io/barbrickdesign.github.io/GeneratedSkills/Demonic Entity Identifier/skill-package/interactionModels/custom/en-US.json
...
// Demonic Entity Identifier — category: identifier, theme: general
...
const LaunchRequestHandler = {
  ...
  handle(handlerInput) {
    const speakOutput = "Demonic Entity Identifier is online. I can identify any general creature, entity, or type based on your description. Describe what you've encountered, or say identify something to begin.";
...
const HelpIntentHandler = {
  ...
  handle(handlerInput) {
    const speakOutput = "Demonic Entity Identifier identifies general entities based on descriptions. Say identify or describe what you've found, and I'll classify it.";
    return handlerInput.responseBuilder
      .speak(speakOutput)
      .reprompt("Tell me what you want to identify, or say identify something.")
      .getResponse();
...
const UnhandledIntentHandler = {
  ...
  handle(handlerInput) {
    ...
    const speakOutput = `I heard ${intentName}, but Demonic Entity Identifier works best with its main commands right now. Demonic Entity Identifier identifies general entities based on descriptions. Say identify or describe what you've found, and I'll classify it.`;
    return handlerInput.responseBuilder
      .speak(speakOutput)
      .reprompt("Tell me what you want to identify, or say identify something.")
      .getResponse();
