RootIB: RB-20260511160643-C3BC830E

TASK: Generate complete, functional Alexa skill code for this GeneratedSkills entry before deployment.

INPUT:
- Skill name: Imperator's Daily Orders
- Invocation: imperators daily orders
- Category: briefing
...
- Lambda handler path: /home/runner/work/barbrickdesign.github.io/barbrickdesign.github.io/GeneratedSkills/Imperator's Daily Orders/lambda/index.js
- Interaction model path: /home/runner/work/barbrickdesign.github.io/barbrickdesign.github.io/GeneratedSkills/Imperator's Daily Orders/skill-package/interactionModels/custom/en-US.json
...
// Imperator's Daily Orders — category: briefing, theme: general
...
const LaunchRequestHandler = {
  ...
  handle(handlerInput) {
    const speakOutput = "Imperator's Daily Orders is transmitting. Today's versatile briefing from your world is ready. Say start briefing or status report to receive your update.";
...
const HelpIntentHandler = {
  ...
  handle(handlerInput) {
    const speakOutput = "Imperator's Daily Orders delivers versatile status briefings and updates from your world. Say start briefing for the latest report.";
    return handlerInput.responseBuilder
      .speak(speakOutput)
      .reprompt("Say start briefing or status report.")
      .getResponse();
...
const UnhandledIntentHandler = {
  ...
  handle(handlerInput) {
    ...
    const speakOutput = `I heard ${intentName}, but Imperator's Daily Orders works best with its main commands right now. Imperator's Daily Orders delivers versatile status briefings and updates from your world. Say start briefing for the latest report.`;
    return handlerInput.responseBuilder
      .speak(speakOutput)
      .reprompt("Say start briefing or status report.")
      .getResponse();
