RootIB: RB-20260511160643-D033EEBE

TASK: Generate complete, functional Alexa skill code for this GeneratedSkills entry before deployment.

INPUT:
- Skill name: Character Creator
- Invocation: character creator
- Category: character
- Description: Interact with the voices and wisdom of your world. Get versatile quotes, character lines, and memorable dialogue delivered straight to your Alexa device.
- Lambda handler path: /home/runner/work/barbrickdesign.github.io/barbrickdesign.github.io/GeneratedSkills/Character Creator/lambda/index.js
- Interaction model path: /home/runner/work/barbrickdesign.github.io/barbrickdesign.github.io/GeneratedSkills/Character Creator/skill-package/interactionModels/custom/en-US.json
...
// Character Creator — category: character, theme: general
...
const LaunchRequestHandler = {
  ...
  handle(handlerInput) {
    const speakOutput = "Character Creator is ready. You can ask me to speak in character, share a line, or deliver wisdom from your world. Say speak to hear something versatile, or help for options.";
...
const HelpIntentHandler = {
  ...
  handle(handlerInput) {
    const speakOutput = "Character Creator channels characters and voices from your world. Say speak or give me a line for versatile dialogue.";
    return handlerInput.responseBuilder
      .speak(speakOutput)
      .reprompt("Say speak or ask me something from your world.")
      .getResponse();
...
const UnhandledIntentHandler = {
  ...
  handle(handlerInput) {
    ...
    const speakOutput = `I heard ${intentName}, but Character Creator works best with its main commands right now. Character Creator channels characters and voices from your world. Say speak or give me a line for versatile dialogue.`;
    return handlerInput.responseBuilder
      .speak(speakOutput)
      .reprompt("Say speak or ask me something from your world.")
      .getResponse();
