RootIB: RB-20260511150354-4D3A19BA

TASK: Generate complete, functional Alexa skill code for this GeneratedSkills entry before deployment.

INPUT:
- Skill name: Anti-Hero Code of Ethics Game
- Invocation: anti hero code of ethics game
- Category: game
...
- Lambda handler path: /home/runner/work/barbrickdesign.github.io/barbrickdesign.github.io/GeneratedSkills/Anti-Hero Code of Ethics Game/lambda/index.js
- Interaction model path: /home/runner/work/barbrickdesign.github.io/barbrickdesign.github.io/GeneratedSkills/Anti-Hero Code of Ethics Game/skill-package/interactionModels/custom/en-US.json
...
// Anti-Hero Code of Ethics Game — category: game, theme: general
...
const LaunchRequestHandler = {
  ...
  handle(handlerInput) {
    const speakOutput = "Welcome to Anti-Hero Code of Ethics Game! Enter the versatile world of your world and take on the challenge. Say start game to begin, or help for instructions.";
...
const HelpIntentHandler = {
  ...
  handle(handlerInput) {
    const speakOutput = "Anti-Hero Code of Ethics Game is an interactive versatile experience set in your world. Say start game to begin, and follow the prompts to navigate the adventure.";
    return handlerInput.responseBuilder
      .speak(speakOutput)
      .reprompt("Say start game to begin, or help for instructions.")
      .getResponse();
...
const UnhandledIntentHandler = {
  ...
  handle(handlerInput) {
    ...
    const speakOutput = `I heard ${intentName}, but Anti-Hero Code of Ethics Game works best with its main commands right now. Anti-Hero Code of Ethics Game is an interactive versatile experience set in your world. Say start game to begin, and follow the prompts to navigate the adventure.`;
    return handlerInput.responseBuilder
      .speak(speakOutput)
      .reprompt("Say start game to begin, or help for instructions.")
      .getResponse();
