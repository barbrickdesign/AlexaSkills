RootIB: RB-20260511160643-A36719A8

TASK: Generate complete, functional Alexa skill code for this GeneratedSkills entry before deployment.

INPUT:
- Skill name: Raccoon City Lore Quiz
- Invocation: raccoon city lore quiz
- Category: trivia
...
- Lambda handler path: /home/runner/work/barbrickdesign.github.io/barbrickdesign.github.io/GeneratedSkills/Raccoon City Lore Quiz/lambda/index.js
- Interaction model path: /home/runner/work/barbrickdesign.github.io/barbrickdesign.github.io/GeneratedSkills/Raccoon City Lore Quiz/skill-package/interactionModels/custom/en-US.json
...
// Raccoon City Lore Quiz — category: trivia, theme: general
...
const LaunchRequestHandler = {
  ...
  handle(handlerInput) {
    const speakOutput = "Welcome to Raccoon City Lore Quiz! Test your knowledge of your world across versatile trivia challenges. Say start trivia to begin, or help for instructions.";
...
const HelpIntentHandler = {
  ...
  handle(handlerInput) {
    const speakOutput = "Raccoon City Lore Quiz tests your knowledge of your world. Say start trivia to get versatile questions and track your score.";
    return handlerInput.responseBuilder
      .speak(speakOutput)
      .reprompt("Say start trivia to begin, or help for instructions.")
      .getResponse();
...
const CancelAndStopIntentHandler = {
  ...
  handle(handlerInput) {
    const speakOutput = "Thanks for playing Raccoon City Lore Quiz. Keep exploring your world!";
    return handlerInput.responseBuilder
      .speak(speakOutput)
      .getResponse();
  }
...
const UnhandledIntentHandler = {
  ...
  handle(handlerInput) {
    ...
    const speakOutput = `I heard ${intentName}, but Raccoon City Lore Quiz works best with its main commands right now. Raccoon City Lore Quiz tests your knowledge of your world. Say start trivia to get versatile questions and track your score.`;
    return handlerInput.responseBuilder
      .speak(speakOutput)
      .reprompt("Say start trivia to begin, or help for instructions.")
      .getResponse();
