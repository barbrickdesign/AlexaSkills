...
- Lambda handler path: /home/runner/work/barbrickdesign.github.io/barbrickdesign.github.io/GeneratedSkills/Ask the Wizard/lambda/index.js
- Interaction model path: /home/runner/work/barbrickdesign.github.io/barbrickdesign.github.io/GeneratedSkills/Ask the Wizard/skill-package/interactionModels/custom/en-US.json
...
// Ask the Wizard — category: character, theme: general
...
const LaunchRequestHandler = {
  ...
  handle(handlerInput) {
    const speakOutput = "Ask the Wizard is ready. You can ask me to speak in character, share a line, or deliver wisdom from your world. Say speak to hear something versatile, or help for options.";
...
const HelpIntentHandler = {
  ...
  handle(handlerInput) {
    const speakOutput = "Ask the Wizard channels characters and voices from your world. Say speak or give me a line for versatile dialogue.";
    return handlerInput.responseBuilder
      .speak(speakOutput)
      .reprompt("Say speak or ask me something from your world.")
      .getResponse();
...
const UnhandledIntentHandler = {
  ...
  handle(handlerInput) {
    ...
    const speakOutput = `I heard ${intentName}, but Ask the Wizard works best with its main commands right now. Ask the Wizard channels characters and voices from your world. Say speak or give me a line for versatile dialogue.`;
    return handlerInput.responseBuilder
      .speak(speakOutput)
      .reprompt("Say speak or ask me something from your world.")
      .getResponse();
