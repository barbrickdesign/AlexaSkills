RootIB: RB-20260511160643-F73046F2

TASK: Generate complete, functional Alexa skill code for this GeneratedSkills entry before deployment.

INPUT:
- Skill name: Enchanted Quote Machine
- Invocation: enchanted quote machine
- Category: character
- Description: Interact with the voices and wisdom of Andalasia. Get fairy-tale quotes, character lines, and memorable dialogue delivered straight to your Alexa device.
- Lambda handler path: /home/runner/work/barbrickdesign.github.io/barbrickdesign.github.io/GeneratedSkills/Enchanted Quote Machine/lambda/index.js
- Interaction model path: /home/runner/work/barbrickdesign.github.io/barbrickdesign.github.io/GeneratedSkills/Enchanted Quote Machine/skill-package/interactionModels/custom/en-US.json
