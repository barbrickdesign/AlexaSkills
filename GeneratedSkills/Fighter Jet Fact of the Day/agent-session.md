RootIB: RB-20260511160643-CC9620E0

TASK: Generate complete, functional Alexa skill code for this GeneratedSkills entry before deployment.

INPUT:
- Skill name: Fighter Jet Fact of the Day
- Invocation: fighter jet fact of the day
- Category: fact-of-day
- Description: Discover something new every day with tactical facts about the battlefield. Expand your knowledge with fascinating insights from the battlefield.
- Lambda handler path: /home/runner/work/barbrickdesign.github.io/barbrickdesign.github.io/GeneratedSkills/Fighter Jet Fact of the Day/lambda/index.js
- Interaction model path: /home/runner/work/barbrickdesign.github.io/barbrickdesign.github.io/GeneratedSkills/Fighter Jet Fact of the Day/skill-package/interactionModels/custom/en-US.json
...
// Fighter Jet Fact of the Day — category: fact-of-day, theme: military history
...
const LaunchRequestHandler = {
  ...
  handle(handlerInput) {
    const speakOutput = "Fighter Jet Fact of the Day is ready with today's tactical fact from the battlefield. Say give me a fact for your daily discovery, or help for options.";
...
const HelpIntentHandler = {
  ...
  handle(handlerInput) {
    const speakOutput = "Fighter Jet Fact of the Day delivers a fresh tactical fact from the battlefield each day. Say give me a fact to hear today's discovery.";
    return handlerInput.responseBuilder
      .speak(speakOutput)
      .reprompt("Say give me a fact for today's discovery.")
      .getResponse();
...
const UnhandledIntentHandler = {
  ...
  handle(handlerInput) {
    ...
    const speakOutput = `I heard ${intentName}, but Fighter Jet Fact of the Day works best with its main commands right now. Fighter Jet Fact of the Day delivers a fresh tactical fact from the battlefield each day. Say give me a fact to hear today's discovery.`;
    return handlerInput.responseBuilder
      .speak(speakOutput)
      .reprompt("Say give me a fact for today's discovery.")
      .getResponse();
