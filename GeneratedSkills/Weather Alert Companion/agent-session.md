RootIB: RB-20260511160643-C0D777EC

TASK: Generate complete, functional Alexa skill code for this GeneratedSkills entry before deployment.

INPUT:
- Skill name: Weather Alert Companion
- Invocation: weather alert companion
- Category: guide
...
- Lambda handler path: /home/runner/work/barbrickdesign.github.io/barbrickdesign.github.io/GeneratedSkills/Weather Alert Companion/lambda/index.js
- Interaction model path: /home/runner/work/barbrickdesign.github.io/barbrickdesign.github.io/GeneratedSkills/Weather Alert Companion/skill-package/interactionModels/custom/en-US.json
...
// Weather Alert Companion — category: guide, theme: general
...
const LaunchRequestHandler = {
  ...
  handle(handlerInput) {
    const speakOutput = "Weather Alert Companion is your expert versatile guide for your world. Ask for tips, guidance, or say give me advice for your first recommendation.";
...
const HelpIntentHandler = {
  ...
  handle(handlerInput) {
    const speakOutput = "Weather Alert Companion provides versatile guidance and expert advice for navigating your world. Say give me advice or give me a tip to get started.";
    return handlerInput.responseBuilder
      .speak(speakOutput)
      .reprompt("Say give me advice or ask for tips about your world.")
      .getResponse();
...
const UnhandledIntentHandler = {
  ...
  handle(handlerInput) {
    ...
    const speakOutput = `I heard ${intentName}, but Weather Alert Companion works best with its main commands right now. Weather Alert Companion provides versatile guidance and expert advice for navigating your world. Say give me advice or give me a tip to get started.`;
    return handlerInput.responseBuilder
      .speak(speakOutput)
      .reprompt("Say give me advice or ask for tips about your world.")
      .getResponse();
