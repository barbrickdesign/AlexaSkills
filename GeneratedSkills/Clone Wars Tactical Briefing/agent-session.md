RootIB: RB-20260511160643-F24D324B

TASK: Generate complete, functional Alexa skill code for this GeneratedSkills entry before deployment.

INPUT:
- Skill name: Clone Wars Tactical Briefing
- Invocation: clone wars tactical briefing
- Category: briefing
...
- Lambda handler path: /home/runner/work/barbrickdesign.github.io/barbrickdesign.github.io/GeneratedSkills/Clone Wars Tactical Briefing/lambda/index.js
- Interaction model path: /home/runner/work/barbrickdesign.github.io/barbrickdesign.github.io/GeneratedSkills/Clone Wars Tactical Briefing/skill-package/interactionModels/custom/en-US.json
...
// Clone Wars Tactical Briefing — category: briefing, theme: star wars
...
const LaunchRequestHandler = {
  ...
  handle(handlerInput) {
    const speakOutput = "Clone Wars Tactical Briefing is transmitting. Today's galactic briefing from galaxy far, far away is ready. Say start briefing or status report to receive your update.";
...
const HelpIntentHandler = {
  ...
  handle(handlerInput) {
    const speakOutput = "Clone Wars Tactical Briefing delivers galactic status briefings and updates from galaxy far, far away. Say start briefing for the latest report.";
    return handlerInput.responseBuilder
      .speak(speakOutput)
      .reprompt("Say start briefing or status report.")
      .getResponse();
...
const UnhandledIntentHandler = {
  ...
  handle(handlerInput) {
    ...
    const speakOutput = `I heard ${intentName}, but Clone Wars Tactical Briefing works best with its main commands right now. Clone Wars Tactical Briefing delivers galactic status briefings and updates from galaxy far, far away. Say start briefing for the latest report.`;
    return handlerInput.responseBuilder
      .speak(speakOutput)
      .reprompt("Say start briefing or status report.")
      .getResponse();
