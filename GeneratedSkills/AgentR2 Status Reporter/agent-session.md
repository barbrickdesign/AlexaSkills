RootIB: RB-20260511150354-22754CAF

TASK: Generate complete, functional Alexa skill code for this GeneratedSkills entry before deployment.

INPUT:
- Skill name: AgentR2 Status Reporter
- Invocation: agentr2 status reporter
- Category: briefing
...
- Lambda handler path: /home/runner/work/barbrickdesign.github.io/barbrickdesign.github.io/GeneratedSkills/AgentR2 Status Reporter/lambda/index.js
- Interaction model path: /home/runner/work/barbrickdesign.github.io/barbrickdesign.github.io/GeneratedSkills/AgentR2 Status Reporter/skill-package/interactionModels/custom/en-US.json
...
// AgentR2 Status Reporter — category: briefing, theme: star wars
...
const LaunchRequestHandler = {
  ...
  handle(handlerInput) {
    const speakOutput = "AgentR2 Status Reporter is transmitting. Today's galactic briefing from galaxy far, far away is ready. Say start briefing or status report to receive your update.";
...
const HelpIntentHandler = {
  ...
  handle(handlerInput) {
    const speakOutput = "AgentR2 Status Reporter delivers galactic status briefings and updates from galaxy far, far away. Say start briefing for the latest report.";
    return handlerInput.responseBuilder
      .speak(speakOutput)
      .reprompt("Say start briefing or status report.")
      .getResponse();
...
const UnhandledIntentHandler = {
  ...
  handle(handlerInput) {
    ...
    const speakOutput = `I heard ${intentName}, but AgentR2 Status Reporter works best with its main commands right now. AgentR2 Status Reporter delivers galactic status briefings and updates from galaxy far, far away. Say start briefing for the latest report.`;
    return handlerInput.responseBuilder
      .speak(speakOutput)
      .reprompt("Say start briefing or status report.")
      .getResponse();
