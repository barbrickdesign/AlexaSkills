RootIB: RB-20260511160643-C01904BD

TASK: Generate complete, functional Alexa skill code for this GeneratedSkills entry before deployment.

INPUT:
- Skill name: Ask the Pirate Captain
- Invocation: ask the pirate captain
- Category: character
...
- Lambda handler path: /home/runner/work/barbrickdesign.github.io/barbrickdesign.github.io/GeneratedSkills/Ask the Pirate Captain/lambda/index.js
- Interaction model path: /home/runner/work/barbrickdesign.github.io/barbrickdesign.github.io/GeneratedSkills/Ask the Pirate Captain/skill-package/interactionModels/custom/en-US.json
...
// Ask the Pirate Captain — category: character, theme: pirates
...
const LaunchRequestHandler = {
  ...
  handle(handlerInput) {
    const speakOutput = "Ask the Pirate Captain is ready. You can ask me to speak in character, share a line, or deliver wisdom from the high seas. Say speak to hear something swashbuckling, or help for options.";
...
const HelpIntentHandler = {
  ...
  handle(handlerInput) {
    const speakOutput = "Ask the Pirate Captain channels characters and voices from the high seas. Say speak or give me a line for swashbuckling dialogue.";
    return handlerInput.responseBuilder
      .speak(speakOutput)
      .reprompt("Say speak or ask me something from the high seas.")
      .getResponse();
...
const UnhandledIntentHandler = {
  ...
  handle(handlerInput) {
    ...
    const speakOutput = `I heard ${intentName}, but Ask the Pirate Captain works best with its main commands right now. Ask the Pirate Captain channels characters and voices from the high seas. Say speak or give me a line for swashbuckling dialogue.`;
    return handlerInput.responseBuilder
      .speak(speakOutput)
      .reprompt("Say speak or ask me something from the high seas.")
      .getResponse();
