RootIB: RB-20260511160643-F45986AC

TASK: Generate complete, functional Alexa skill code for this GeneratedSkills entry before deployment.

INPUT:
- Skill name: Stress-Relief Breathing Guide
- Invocation: stress relief breathing guide
- Category: guide
...
- Lambda handler path: /home/runner/work/barbrickdesign.github.io/barbrickdesign.github.io/GeneratedSkills/Stress-Relief Breathing Guide/lambda/index.js
- Interaction model path: /home/runner/work/barbrickdesign.github.io/barbrickdesign.github.io/GeneratedSkills/Stress-Relief Breathing Guide/skill-package/interactionModels/custom/en-US.json
...
// Stress-Relief Breathing Guide — category: guide, theme: wellness
...
const LaunchRequestHandler = {
  ...
  handle(handlerInput) {
    const speakOutput = "Stress-Relief Breathing Guide is your expert wellness guide for a peaceful space. Ask for tips, guidance, or say give me advice for your first recommendation.";
...
const HelpIntentHandler = {
  ...
  handle(handlerInput) {
    const speakOutput = "Stress-Relief Breathing Guide provides wellness guidance and expert advice for navigating a peaceful space. Say give me advice or give me a tip to get started.";
    return handlerInput.responseBuilder
      .speak(speakOutput)
      .reprompt("Say give me advice or ask for tips about a peaceful space.")
      .getResponse();
...
const UnhandledIntentHandler = {
  ...
  handle(handlerInput) {
    ...
    const speakOutput = `I heard ${intentName}, but Stress-Relief Breathing Guide works best with its main commands right now. Stress-Relief Breathing Guide provides wellness guidance and expert advice for navigating a peaceful space. Say give me advice or give me a tip to get started.`;
    return handlerInput.responseBuilder
      .speak(speakOutput)
      .reprompt("Say give me advice or ask for tips about a peaceful space.")
      .getResponse();
