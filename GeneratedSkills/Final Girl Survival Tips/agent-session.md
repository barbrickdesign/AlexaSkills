RootIB: RB-20260511160643-8995A213

TASK: Generate complete, functional Alexa skill code for this GeneratedSkills entry before deployment.

INPUT:
- Skill name: Final Girl Survival Tips
- Invocation: final girl survival tips
- Category: guide
...
- Lambda handler path: /home/runner/work/barbrickdesign.github.io/barbrickdesign.github.io/GeneratedSkills/Final Girl Survival Tips/lambda/index.js
- Interaction model path: /home/runner/work/barbrickdesign.github.io/barbrickdesign.github.io/GeneratedSkills/Final Girl Survival Tips/skill-package/interactionModels/custom/en-US.json
...
// Final Girl Survival Tips — category: guide, theme: horror
...
const LaunchRequestHandler = {
  ...
  handle(handlerInput) {
    const speakOutput = "Final Girl Survival Tips is your expert terrifying guide for the horror realm. Ask for tips, guidance, or say give me advice for your first recommendation.";
...
const HelpIntentHandler = {
  ...
  handle(handlerInput) {
    const speakOutput = "Final Girl Survival Tips provides terrifying guidance and expert advice for navigating the horror realm. Say give me advice or give me a tip to get started.";
    return handlerInput.responseBuilder
      .speak(speakOutput)
      .reprompt("Say give me advice or ask for tips about the horror realm.")
      .getResponse();
...
const UnhandledIntentHandler = {
  ...
  handle(handlerInput) {
    ...
    const speakOutput = `I heard ${intentName}, but Final Girl Survival Tips works best with its main commands right now. Final Girl Survival Tips provides terrifying guidance and expert advice for navigating the horror realm. Say give me advice or give me a tip to get started.`;
    return handlerInput.responseBuilder
      .speak(speakOutput)
      .reprompt("Say give me advice or ask for tips about the horror realm.")
      .getResponse();
