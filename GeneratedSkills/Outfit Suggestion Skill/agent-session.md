RootIB: RB-20260511160643-36927B7E

TASK: Generate complete, functional Alexa skill code for this GeneratedSkills entry before deployment.

INPUT:
- Skill name: Outfit Suggestion Skill
- Invocation: outfit suggestion skill
- Category: utility
- Description: Outfit Suggestion Skill is a stylish Alexa skill designed to assist you with everyday tasks related to the lifestyle scene.
- Lambda handler path: /home/runner/work/barbrickdesign.github.io/barbrickdesign.github.io/GeneratedSkills/Outfit Suggestion Skill/lambda/index.js
- Interaction model path: /home/runner/work/barbrickdesign.github.io/barbrickdesign.github.io/GeneratedSkills/Outfit Suggestion Skill/skill-package/interactionModels/custom/en-US.json
