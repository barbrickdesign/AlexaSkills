RootIB: RB-20260511160643-B16E4A71

TASK: Generate complete, functional Alexa skill code for this GeneratedSkills entry before deployment.

INPUT:
- Skill name: Mutant Power Identifier
- Invocation: mutant power identifier
- Category: identifier
...
- Lambda handler path: /home/runner/work/barbrickdesign.github.io/barbrickdesign.github.io/GeneratedSkills/Mutant Power Identifier/lambda/index.js
- Interaction model path: /home/runner/work/barbrickdesign.github.io/barbrickdesign.github.io/GeneratedSkills/Mutant Power Identifier/skill-package/interactionModels/custom/en-US.json
...
// Mutant Power Identifier — category: identifier, theme: marvel
...
const LaunchRequestHandler = {
  ...
  handle(handlerInput) {
    const speakOutput = "Mutant Power Identifier is online. I can identify any marvel creature, entity, or type based on your description. Describe what you've encountered, or say identify something to begin.";
...
const HelpIntentHandler = {
  ...
  handle(handlerInput) {
    const speakOutput = "Mutant Power Identifier identifies marvel entities based on descriptions. Say identify or describe what you've found, and I'll classify it.";
    return handlerInput.responseBuilder
      .speak(speakOutput)
      .reprompt("Tell me what you want to identify, or say identify something.")
      .getResponse();
...
const UnhandledIntentHandler = {
  ...
  handle(handlerInput) {
    ...
    const speakOutput = `I heard ${intentName}, but Mutant Power Identifier works best with its main commands right now. Mutant Power Identifier identifies marvel entities based on descriptions. Say identify or describe what you've found, and I'll classify it.`;
    return handlerInput.responseBuilder
      .speak(speakOutput)
      .reprompt("Tell me what you want to identify, or say identify something.")
      .getResponse();
